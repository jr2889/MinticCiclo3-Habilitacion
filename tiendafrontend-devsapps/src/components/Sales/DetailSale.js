...
export default function Create() {
  ...
  const postData = () => {  
    if (cantidad!=='') {    
      //axios.post(`mongodb+srv://betadev:betadev@cluster0.anesk.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`,  { headers: {token: sessionStorage.getItem('token')},
      axios.post(`mongodb+srv://dbmanager:dbmanager@cluster0.klsd9.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`,  { headers: {token: sessionStorage.getItem('token')},
        dni, descrip, value, cantidad }).then(
