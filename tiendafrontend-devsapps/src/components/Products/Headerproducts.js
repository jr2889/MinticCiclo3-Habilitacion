...
const DropdownExamplePointing = () => (
  ...
  <div >
    ...
    <Menu color={"red"} inverted >
      <Menu.Item> <i class="shopping cart icon"> </i>Sistema de Ventas Devs APP</Menu.Item>
      ...
      <Dropdown text='Ventas' className='link item' >
        <Dropdown.Menu>
        <Dropdown.Item  href="./createsale" >Agregar Ventas</Dropdown.Item>
      ...
      <Dropdown text='Productos' pointing className='link item'>
        <Dropdown.Menu>
          <Dropdown.Item href="./createprod">Agregar Productos</Dropdown.Item>
      ...
      <Dropdown text='Usuarios' pointing className='link item'>
        <Dropdown.Menu>
          <Dropdown.Item href="./createusers">Agregar Usuarios</Dropdown.Item>
